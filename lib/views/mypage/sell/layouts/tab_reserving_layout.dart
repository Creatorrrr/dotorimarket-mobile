...
import 'package:dotorimarket/views/mypage/sell/widgets/sell_reserving_list_item.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

class TabReservingLayout extends StatefulWidget {
  final SharedPreferences prefs;

  TabReservingLayout(this.prefs, {
    Key key,
  }):super(key: key);

  @override
  State<StatefulWidget> createState() => _TabReservingLayoutState();
}

class _TabReservingLayoutState extends State<TabReservingLayout> {
              ...
              Expanded(
                child: ListView.builder(
                  itemBuilder: (BuildContext context, int index) {
                    return SellReservingListItem(dealList[index],
                      onItemPressed: () {
